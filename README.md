...
redistributes GPL border data — see its README). A future site that ships no GPL material
may carry its own `LICENSE` file inside its folder; until one does, everything here is GPL.
